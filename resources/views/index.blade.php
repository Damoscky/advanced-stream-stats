                    ...
                    <form action="{{route('auth.index')}}">
                      <div class="row">
                        <div class="form-group col-md-12 mb-4">
                          <input type="text" class="form-control input-lg" id="lastname" aria-describedby="nameHelp" placeholder="Last Name">
                        </div>
                        <div class="form-group col-md-12 mb-4">
                            <input type="text" class="form-control input-lg" id="firstname" aria-describedby="nameHelp" placeholder="First Name">
                          </div>
                        <div class="form-group col-md-12 mb-4">
                        ...
                        <div class="col-md-12">
                          ...
                          <p>Already have an account?
                            <a class="text-blue" href="{{ route('auth.login') }}">Sign in</a>
                          </p>
                        </div>
                      </div>
                    </form>
